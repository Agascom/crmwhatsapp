...
exports.AddIntegrationFabric1781900000000 = void 0;
class AddIntegrationFabric1781900000000 {
    ...
    async up(queryRunner) {
        ...
        if (!(await queryRunner.hasTable('plugin_instances'))) {
            await queryRunner.query(`CREATE TABLE "plugin_instances" (` +
            ...
            await queryRunner.query(`CREATE UNIQUE INDEX "UQ_plugin_instances_plugin_instance" ON "plugin_instances" ("pluginId", "instanceId")`);
        }
        if (!(await queryRunner.hasTable('conversation_mappings'))) {
            await queryRunner.query(`CREATE TABLE "conversation_mappings" (` +
            ...
            await queryRunner.query(`CREATE UNIQUE INDEX "UQ_conversation_mappings_forward" ON "conversation_mappings" ("sessionId", "chatId", "pluginId", "instanceId")`);
            await queryRunner.query(`CREATE UNIQUE INDEX "UQ_conversation_mappings_reverse" ON "conversation_mappings" ("pluginId", "instanceId", "providerConversationId")`);
        }
        if (!(await queryRunner.hasTable('ingress_events'))) {
            await queryRunner.query(`CREATE TABLE "ingress_events" (` +
        ...
        if (!(await queryRunner.hasTable('integration_delivery_failures'))) {
            await queryRunner.query(`CREATE TABLE "integration_delivery_failures" (` +
            ...
            await queryRunner.query(`CREATE INDEX "IDX_integration_delivery_failures_instance" ON "integration_delivery_failures" ("pluginId", "instanceId")`);
        }
    }
...
exports.AddIntegrationFabric1781900000000 = AddIntegrationFabric1781900000000;
//# sourceMappingURL=1781900000000-AddIntegrationFabric.js.map